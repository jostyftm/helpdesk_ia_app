...
export const useTickets = () => {
    ...
    }, [page, sort, debouncedSubject, debouncedDescription, filters?.ticket_category_id, filters?.ticket_priority_id, filters?.ticket_source_id, filters?.state_id, filters?.start_after]);
