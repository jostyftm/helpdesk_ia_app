    ...
    return (
        <div className="w-full px-4 sm:px-6 md:px-8 py-8 h-full flex flex-col space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-0 gap-4">
                <div className="flex flex-wrap items-center gap-2 bg-slate-100/50 p-1.5 rounded-xl sm:rounded-full w-full sm:w-auto overflow-x-auto custom-scrollbar">
                    <button
                ...
                <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm animate-in fade-in slide-in-from-top-2 relative">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
                        ...
                        <div className="md:col-span-4 grid grid-cols-1 md:grid-cols-2 gap-5">
                             <div>
                                <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Buscar en Descripción</label>
                                <input
                                    type="text"
